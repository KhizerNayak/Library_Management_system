...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="Content/adminbookissuing/StyleSheet1.css" rel="stylesheet" />
         ...
         <div class="col-md-5">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-6">
                        <asp:Button ID="Button2" OnClick="Button2_Click" class="btn btn-lg btn-block btn-primary" runat="server" Text="Issue" />
                     </div>
                     <div class="col-6">
                        <asp:Button ID="Button4" OnClick="Button4_Click" class="btn btn-lg btn-block btn-success" runat="server" Text="Return" />
                     </div>
                  </div>
               </div>
            </div>
